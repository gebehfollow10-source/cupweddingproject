...
const FONT_OPTIONS={
 ...
 lato:{label:"Lato — Soft Modern",css:"Cupz-Lato",file:"/fonts/Lato-Regular.ttf",pdfFile:"Lato-Regular.ttf",pdfName:"CupzLato"},
 roboto:{label:"Roboto — Clean",css:"Cupz-Roboto",file:"/fonts/Roboto-Regular.ttf",pdfFile:"Roboto-Regular.ttf",pdfName:"CupzRoboto"},
 garamond:{label:"EB Garamond — Luxury Serif",css:"Cupz-Garamond",file:"/fonts/EBGaramond-Regular.ttf",pdfFile:"EBGaramond-Regular.ttf",pdfName:"CupzGaramond"},
 dejavuserif:{label:"DejaVu Serif — Traditional",css:"Cupz-DejaVuSerif",file:"/fonts/DejaVuSerif.ttf",pdfFile:"DejaVuSerif.ttf",pdfName:"CupzDejaVuSerif"},
 dejavusans:{label:"DejaVu Sans — Friendly",css:"Cupz-DejaVuSans",file:"/fonts/DejaVuSans.ttf",pdfFile:"DejaVuSans.ttf",pdfName:"CupzDejaVuSans"},
 notoserif:{label:"Noto Serif — Refined",css:"Cupz-NotoSerif",file:"/fonts/NotoSerif-Regular.ttf",pdfFile:"NotoSerif-Regular.ttf",pdfName:"CupzNotoSerif"},
 notoserifdisplay:{label:"Noto Serif Display — Luxury",css:"Cupz-NotoSerifDisplay",file:"/fonts/NotoSerifDisplay-Regular.ttf",pdfFile:"NotoSerifDisplay-Regular.ttf",pdfName:"CupzNotoSerifDisplay"},
 notosans:{label:"Noto Sans — Universal",css:"Cupz-NotoSans",file:"/fonts/NotoSans-Regular.ttf",pdfFile:"NotoSans-Regular.ttf",pdfName:"CupzNotoSans"},
 notosansdisplay:{label:"Noto Sans Display — Contemporary",css:"Cupz-NotoSansDisplay",file:"/fonts/NotoSansDisplay-Regular.ttf",pdfFile:"NotoSansDisplay-Regular.ttf",pdfName:"CupzNotoSansDisplay"},
 opensans:{label:"Open Sans — Wedding",css:"Cupz-OpenSans",file:"/fonts/OpenSans-Regular.ttf",pdfFile:"OpenSans-Regular.ttf",pdfName:"CupzOpenSans"},
 nanumgothic:{label:"Nanum Gothic — Wedding",css:"Cupz-NanumGothic",file:"/fonts/NanumGothic.ttf",pdfFile:"NanumGothic.ttf",pdfName:"CupzNanumGothic"},
 andika:{label:"Andika — Wedding",css:"Cupz-Andika",file:"/fonts/Andika-Regular.ttf",pdfFile:"Andika-Regular.ttf",pdfName:"CupzAndika"},
 gentium:{label:"Gentium — Wedding",css:"Cupz-Gentium",file:"/fonts/Gentium-R.ttf",pdfFile:"Gentium-R.ttf",pdfName:"CupzGentium"},
 amiri:{label:"Amiri — Wedding",css:"Cupz-Amiri",file:"/fonts/Amiri-Regular.ttf",pdfFile:"Amiri-Regular.ttf",pdfName:"CupzAmiri"},
 accanthis:{label:"Accanthis ADF — Wedding",css:"Cupz-AccanthisADF",file:"/fonts/AccanthisADFStdNo2-Regular.otf",pdfFile:"AccanthisADFStdNo2-Regular.otf",pdfName:"CupzAccanthisADF"},
 artemisia:{label:"GFS Artemisia — Wedding",css:"Cupz-GFSArtemisia",file:"/fonts/GFSArtemisia.otf",pdfFile:"GFSArtemisia.otf",pdfName:"CupzGFSArtemisia"},
 waree:{label:"Waree — Wedding",css:"Cupz-Waree",file:"/fonts/Waree.otf",pdfFile:"Waree.otf",pdfName:"CupzWaree"},
 nimbus:{label:"Nimbus Sans — Wedding",css:"Cupz-NimbusSans",file:"/fonts/NimbusSans-Regular.otf",pdfFile:"NimbusSans-Regular.otf",pdfName:"CupzNimbusSans"},
 bookman:{label:"URW Bookman — Wedding",css:"Cupz-URWBookman",file:"/fonts/URWBookman-Demi.otf",pdfFile:"URWBookman-Demi.otf",pdfName:"CupzURWBookman"},
 freemono:{label:"FreeMono — Wedding",css:"Cupz-FreeMono",file:"/fonts/FreeMono.otf",pdfFile:"FreeMono.otf",pdfName:"CupzFreeMono"},
 robotoslab:{label:"Roboto Slab — Wedding",css:"Cupz-RobotoSlab",file:"/fonts/RobotoSlab-Regular.otf",pdfFile:"RobotoSlab-Regular.otf",pdfName:"CupzRobotoSlab"},
 gentiumplus:{label:"Gentium Alt — Wedding",css:"Cupz-GentiumAlt",file:"/fonts/GentiumAlt-R.ttf",pdfFile:"GentiumAlt-R.ttf",pdfName:"CupzGentiumAlt"},
 notoserifcond:{label:"Noto Serif SemiCondensed — Wedding",css:"Cupz-NotoSerifSemiCondensed",file:"/fonts/NotoSerif-SemiCondensed.ttf",pdfFile:"NotoSerif-SemiCondensed.ttf",pdfName:"CupzNotoSerifSemiCondensed"},
 notosanscond:{label:"Noto Sans ExtraCondensed — Wedding",css:"Cupz-NotoSansExtraCondensed",file:"/fonts/NotoSans-ExtraCondensedExtraLight.ttf",pdfFile:"NotoSans-ExtraCondensedExtraLight.ttf",pdfName:"CupzNotoSansExtraCondensed"},
};
...
const THEME_OPTIONS={
 ...
 champagne:{label:"Champagne Glow",className:"champagne",bg:"#f7efe2",paper:"#fffdf8",soft:"#ead8b8"},
 terracotta:{label:"Terracotta Love",className:"terracotta",bg:"#f6e7df",paper:"#fffaf7",soft:"#e9c4b5"},
 lavender:{label:"Lavender Dream",className:"lavender",bg:"#f1eef8",paper:"#fdfbff",soft:"#ddd4ee"},
 ocean:{label:"Ocean Breeze",className:"ocean",bg:"#e9f4f5",paper:"#fbffff",soft:"#c9e3e5"},
 forest:{label:"Forest Emerald",className:"forest",bg:"#eaf1ec",paper:"#fbfdfb",soft:"#cfdfd4"},
 mocha:{label:"Mocha Velvet",className:"mocha",bg:"#eee6df",paper:"#fffaf6",soft:"#d9c4b5"},
 cherry:{label:"Cherry Romance",className:"cherry",bg:"#f8e9ed",paper:"#fffafb",soft:"#e7b9c6"},
 sky:{label:"Sky Blue",className:"sky",bg:"#edf5fb",paper:"#ffffff",soft:"#d5e7f5"},
 peach:{label:"Peach Garden",className:"peach",bg:"#fff1e8",paper:"#fffdfb",soft:"#f6d2bd"},
 blackwhite:{label:"Black & White",className:"blackwhite",bg:"#111111",paper:"#ffffff",soft:"#eeeeee"},
 olive:{label:"Olive Botanical",className:"olive",bg:"#f0f1e5",paper:"#fcfdf8",soft:"#dfe2c8"},
 dustyrose:{label:"Dusty Rose",className:"dustyrose",bg:"#f6e8ea",paper:"#fffafb",soft:"#e8c7cd"},
 wine:{label:"Burgundy Wine",className:"wine",bg:"#f1e4e6",paper:"#fffafa",soft:"#d9b4bb"},
 coral:{label:"Coral Sunset",className:"coral",bg:"#fff0ea",paper:"#fffaf7",soft:"#f7c6b5"},
 sand:{label:"Warm Sand",className:"sand",bg:"#f4ede3",paper:"#fffdf9",soft:"#e6d4bd"},
 taupe:{label:"Soft Taupe",className:"taupe",bg:"#eee9e4",paper:"#fffdfb",soft:"#d8ccc0"},
 espresso:{label:"Espresso Cream",className:"espresso",bg:"#e8ded7",paper:"#fffaf5",soft:"#cbb7a9"},
 cocoa:{label:"Cocoa Blush",className:"cocoa",bg:"#f0e2dc",paper:"#fffaf7",soft:"#d8b7a9"},
 mauve:{label:"Mauve Mist",className:"mauve",bg:"#eee5ec",paper:"#fdfaff",soft:"#d5c0d2"},
 plum:{label:"Plum Elegance",className:"plum",bg:"#eee3ef",paper:"#fdfaff",soft:"#d0b2d4"},
 lilac:{label:"Lilac Pearl",className:"lilac",bg:"#f3effb",paper:"#fffefe",soft:"#ded4ef"},
 periwinkle:{label:"Periwinkle Sky",className:"periwinkle",bg:"#e9edfb",paper:"#fcfdff",soft:"#cbd5f1"},
 sapphire:{label:"Sapphire Night",className:"sapphire",bg:"#101a33",paper:"#182541",soft:"#2b3d6a"},
 teal:{label:"Teal Romance",className:"teal",bg:"#e7f2ef",paper:"#fbfffe",soft:"#c4ded8"},
 mint:{label:"Mint Whisper",className:"mint",bg:"#e8f3ee",paper:"#fbfffc",soft:"#c9e2d5"},
 eucalyptus:{label:"Eucalyptus",className:"eucalyptus",bg:"#e8f0eb",paper:"#fbfdfb",soft:"#c4d6ca"},
 pine:{label:"Pine & Cream",className:"pine",bg:"#e4ede7",paper:"#fbfdfb",soft:"#bcd1c1"},
 mustard:{label:"Mustard Glow",className:"mustard",bg:"#f5efd9",paper:"#fffdf5",soft:"#e5d38e"},
 terracotta2:{label:"Burnt Terracotta",className:"terracotta2",bg:"#f2e2da",paper:"#fff9f5",soft:"#d7aa96"},
 rosewood:{label:"Rosewood",className:"rosewood",bg:"#eee0dd",paper:"#fff9f7",soft:"#c79c93"},
 porcelain:{label:"Porcelain Blue",className:"porcelain",bg:"#eef3f7",paper:"#ffffff",soft:"#d5e0e9"},
 ice:{label:"Ice Blue",className:"ice",bg:"#e9f6fa",paper:"#fbffff",soft:"#c7e5ec"},
 denim:{label:"Denim Romance",className:"denim",bg:"#e5edf5",paper:"#fbfdff",soft:"#bfd1e4"},
 graphite:{label:"Graphite Minimal",className:"graphite",bg:"#e9e9e9",paper:"#ffffff",soft:"#c9c9c9"},
 charcoal:{label:"Charcoal Luxe",className:"charcoal",bg:"#17191b",paper:"#222629",soft:"#34393d"},
 cream:{label:"Ivory Cream",className:"cream",bg:"#f7f1e3",paper:"#fffdf8",soft:"#e8d8b6"},
 linen:{label:"Natural Linen",className:"linen",bg:"#f3eee5",paper:"#fffdf9",soft:"#ded3c2"},
 candlelight:{label:"Candlelight",className:"candlelight",bg:"#f7efd9",paper:"#fffdf7",soft:"#ead49a"},
 orchid:{label:"Orchid Bloom",className:"orchid",bg:"#f4e9f3",paper:"#fffaff",soft:"#e1c7dc"},
 apricot:{label:"Apricot Love",className:"apricot",bg:"#fff0df",paper:"#fffaf4",soft:"#f3c7a3"},
 peony:{label:"Peony Garden",className:"peony",bg:"#fae9ee",paper:"#fffafd",soft:"#edc0d0"},
 botanical:{label:"Botanical Cream",className:"botanical",bg:"#edf0e4",paper:"#fcfdf8",soft:"#d7ddc6"},
 marble:{label:"Marble Luxe",className:"marble",bg:"#f1f1ef",paper:"#ffffff",soft:"#d9d9d4"},
 rosegold:{label:"Rose Gold",className:"rosegold",bg:"#f5e7e2",paper:"#fffaf8",soft:"#dfb6a7"},
 silk:{label:"Silk Beige",className:"silk",bg:"#f3ece7",paper:"#fffdfb",soft:"#ddc9bc"},
 nightrose:{label:"Night Rose",className:"nightrose",bg:"#211820",paper:"#2b2028",soft:"#5a3b4c"},
 royalblue:{label:"Royal Blue",className:"royalblue",bg:"#e9eef9",paper:"#fbfcff",soft:"#c6d1ea"},
 emerald:{label:"Emerald Luxe",className:"emerald",bg:"#e5f0eb",paper:"#fbfffd",soft:"#bfd9cc"},
 sagecream:{label:"Sage Cream",className:"sagecream",bg:"#eef1e7",paper:"#fffefa",soft:"#d8ddc6"},
};
