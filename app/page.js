...
export default function Home(){
 ...
 return <main style={{"--accent":color}}>
  <header className="top"><div><span className=
  /span><h1>CupzWedding</h1><p>Generator undangan pernikahan digital</p></div><button className="btn" onClick={()=>setOpen(true)}>Buka Undangan</button></header>
